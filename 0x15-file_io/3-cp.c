 ...
 * @file: The name file buffer is storing chars.
 *
 ...
 * @argc: The arguments number supplied to program.
 * @argv: A pointer array of the arguments.
 *
 * Return: 0 on success.
 *
 * Description: If the argument is incorrect - exit code 97.
 * If file_from does not exist or is read - exit code 98.
 * If file_to isnt created or written to - exit code 99.
